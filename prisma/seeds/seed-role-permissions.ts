...
const ROLE_PERMISSIONS: RolePermissionMap = {
  [ROLE_NAMES.BASIC_ADMIN]: [
    ...
    PERMISSION_CODES.SEO_MEDIA.UPLOAD_IMAGE,
    PERMISSION_CODES.SEO_MEDIA.SLOT_CREATE,
    PERMISSION_CODES.SEO_MEDIA.SLOT_VIEW,
    PERMISSION_CODES.SEO_MEDIA.SLOT_UPDATE,
    PERMISSION_CODES.SEO_MEDIA.SLOT_DELETE,
    PERMISSION_CODES.SEO_MEDIA.ITEM_CREATE,
    PERMISSION_CODES.SEO_MEDIA.ITEM_VIEW,
    PERMISSION_CODES.SEO_MEDIA.ITEM_UPDATE,
    PERMISSION_CODES.SEO_MEDIA.ITEM_DELETE,
    PERMISSION_CODES.SEO_MEDIA.ITEM_REORDER,
    PERMISSION_CODES.ADMIN_PAGE.SEO_MEDIA,
    ...
    // REPORTS
    PERMISSION_CODES.REPORT.GET_ALL,
    PERMISSION_CODES.REPORT.GET_BY_ID,
    PERMISSION_CODES.REPORT.UPDATE,
    PERMISSION_CODES.REPORT.DELETE,
  ],
