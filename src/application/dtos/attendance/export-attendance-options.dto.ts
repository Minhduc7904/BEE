import { IsOptionalBoolean, IsOptionalIdNumber } from 'src/shared/decorators/validate'
/**
...
export class ExportAttendanceOptionsDto {
  /** Homework content whose score is included in the export. */
  @IsOptionalIdNumber('ID nội dung bài tập về nhà')
