// src/application/dtos/competition/create-competition.dto.ts
import {
  IsRequiredString,
  IsRequiredDate,
  IsOptionalDate,
...
export class CreateCompetitionDto {
   ...
   */
  @IsRequiredString('Tên cuộc thi', 255, 1)
  title: string
  ...
  /**
   * Thời lượng làm bài (phút); 0 hoặc null = không giới hạn
   * @example 90
   */
  @IsNullableInt('Thời lượng làm bài', 0, 999999)
   ...
   * @example "DRAFT"
   */
  @IsRequiredEnumValue(Visibility, 'Trạng thái hiển thị')
