    ...
    const result = await this.unitOfWork.executeInTransaction(async (repos) => {
      ...
      const updateData: any = {
        ...
        ...(dto.durationMinutes !== undefined && {
          durationMinutes: dto.durationMinutes && dto.durationMinutes > 0 ? dto.durationMinutes : null,
        }),
        ...
        ...(dto.allowViewSolutionYoutubeUrl !== undefined && {
          allowViewSolutionYoutubeUrl: dto.allowViewSolutionYoutubeUrl,
        }),
