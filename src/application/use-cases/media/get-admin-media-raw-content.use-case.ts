...
@Injectable()
export class GetAdminMediaRawContentUseCase {
  constructor(
  ...
  async execute(mediaId: number, expirySeconds = 3600): Promise<BaseResponseDto<MediaRawContentResponseDto>> {
    /* ------------------------------------------------------------------
     * 1. Get media
     * ------------------------------------------------------------------ */
