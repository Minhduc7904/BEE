...
@Injectable()
export class GetParentStudentHomeworkStatisticsUseCase {
  ...
  async execute(
    ...
    const statistics = await this.results.getHomeworkSubmissionStatistics(studentId)
    return BaseResponseDto.success(
      'Lấy thống kê bài tập đã nộp thành công',
