...
import { NotFoundException, UnauthorizedException } from 'src/shared/exceptions/custom-exceptions'
import {
  AuditStatus,
  NotificationLevel,
  NotificationType,
        ...
        for (const paymentUpdate of dto.payments) {
          try {
            ...
            const statusChangedToPaid =
              paymentUpdate.status === TuitionPaymentStatus.PAID && tuitionPayment.status !== TuitionPaymentStatus.PAID
            const paymentIntent = statusChangedToPaid
