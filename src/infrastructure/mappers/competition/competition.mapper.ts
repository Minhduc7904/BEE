...
export class CompetitionMapper {
    ...
    static toDomainCompetition(prismaCompetition: any): Competition | null {
        ...
        return new Competition({
            ...
            startDate: prismaCompetition.startDate ?? undefined,
            endDate: prismaCompetition.endDate ?? undefined,
            ...
            allowViewSolutionYoutubeUrl: prismaCompetition.allowViewSolutionYoutubeUrl ?? false,
            allowViewExamContent: prismaCompetition.allowViewExamContent ?? false,
