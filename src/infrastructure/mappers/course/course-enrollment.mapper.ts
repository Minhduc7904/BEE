...
export class CourseEnrollmentMapper {
  ...
  static toDomainCourseEnrollment(prismaEnrollment: any): CourseEnrollment | undefined {
    ...
    return new CourseEnrollment({
      ...
      type: prismaEnrollment.type as CourseEnrollmentType,
      ...
      course: prismaEnrollment.course ? CourseMapper.toDomainCourse(prismaEnrollment.course) : undefined,
      student: prismaEnrollment.student ? StudentMapper.toDomainStudent(prismaEnrollment.student) : undefined,
    })
  }
