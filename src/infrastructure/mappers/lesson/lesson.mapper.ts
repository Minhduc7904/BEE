...
import { LessonChapterMapper } from './lesson-chapter.mapper'
import { LessonLearningItemMapper } from './lesson-learning-item.mapper'
/**
...
export class LessonMapper {
    ...
    static toDomainLesson(prismaLesson: any): Lesson | undefined {
        ...
        return new Lesson({
            ...
            learningItems: prismaLesson.learningItems ? LessonLearningItemMapper.toDomainLessonLearningItems(prismaLesson.learningItems) : undefined,
            lessonChapters: prismaLesson.lessonChapters ? LessonChapterMapper.toDomainList(prismaLesson.lessonChapters) : undefined,
        })
    }
