  ...
  async assignRoleToUser(userId: number, roleId: number, assignedBy?: number, expiresAt?: Date): Promise<UserRole> {
    ...
    return new UserRole({
      ...
      role: new Role({
        ...
        isAssignable: created.role.isAssignable,
        createdAt: created.role.createdAt,
  ...
  async updateUserRole(userId: number, roleId: number, data: Partial<UserRole>): Promise<UserRole> {
    {
      ...
      return new UserRole({
        userId: userRoleRecord!.userId,
        roleId: userRoleRecord!.roleId,
        assignedAt: userRoleRecord!.assignedAt,
        expiresAt: userRoleRecord!.expiresAt,
        assignedBy: userRoleRecord!.assignedBy,
        isActive: userRoleRecord!.isActive,
        role: new Role({
          roleId: userRoleRecord!.role.roleId,
          roleName: userRoleRecord!.role.roleName,
          isAssignable: userRoleRecord!.role.isAssignable,
          createdAt: userRoleRecord!.role.createdAt,
          description: userRoleRecord!.role.description,
        }),
      })
    }
  }
