...
export const PERMISSIONS = [
  ...
  {
    code: 'payment-intent:create',
    name: 'Tạo payment intent học phí',
    description: 'Tạo payment intent thanh toán online cho học phí đủ điều kiện',
    group: 'TUITION_PAYMENT_MANAGEMENT',
    isSystem: true,
  },
  {
  ...
  // ===================================
  // RECEIVING BANK ACCOUNT MANAGEMENT
  // ===================================
  {
    code: 'receiving-bank-account:get-all',
    name: 'Xem tài khoản nhận tiền học phí',
    description: 'Xem và lọc danh sách tài khoản ngân hàng nhận học phí',
    group: 'RECEIVING_BANK_ACCOUNT_MANAGEMENT',
    isSystem: true,
  },
  {
    code: 'receiving-bank-account:create',
    name: 'Tạo tài khoản nhận tiền học phí',
    description: 'Tạo tài khoản ngân hàng nhận học phí mới',
    group: 'RECEIVING_BANK_ACCOUNT_MANAGEMENT',
    isSystem: true,
  },
  {
    code: 'receiving-bank-account:update',
    name: 'Cập nhật tài khoản nhận tiền học phí',
    description: 'Cập nhật, kích hoạt hoặc ngừng sử dụng tài khoản nhận học phí',
    group: 'RECEIVING_BANK_ACCOUNT_MANAGEMENT',
    isSystem: true,
  },
  {
    code: 'receiving-bank-account:view-sensitive',
    name: 'Xem số tài khoản nhận tiền đầy đủ',
    description: 'Xem số tài khoản ngân hàng nhận học phí không che',
    group: 'RECEIVING_BANK_ACCOUNT_MANAGEMENT',
    isSystem: true,
  },
  {
    code: 'receiving-bank-account:sync-from-sepay',
    name: 'Đồng bộ tài khoản nhận tiền từ SePay',
    description: 'Đồng bộ và cập nhật thông tin tài khoản ngân hàng từ SePay',
    group: 'RECEIVING_BANK_ACCOUNT_MANAGEMENT',
    isSystem: true,
  },
  {
    code: 'receiving-bank-account:view-balance',
    name: 'Xem số dư tài khoản nhận tiền',
    description: 'Xem số dư tài khoản ngân hàng từ SePay',
    group: 'RECEIVING_BANK_ACCOUNT_MANAGEMENT',
    isSystem: true,
  },
  {
    code: 'receiving-bank-account:configure-grade-mapping',
    name: 'Cấu hình tài khoản nhận tiền theo khối',
    description: 'Xem và gán tài khoản nhận tiền tự động cho từng khối học phí',
    group: 'RECEIVING_BANK_ACCOUNT_MANAGEMENT',
    isSystem: true,
  },

  // ===================================
  // BANK TRANSFER TRANSACTION MANAGEMENT
  // ===================================
  {
    code: 'bank-transfer-transaction:get-all',
    name: 'Xem giao dịch chuyển khoản',
    description: 'Xem, lọc và phân trang giao dịch chuyển khoản ngân hàng',
    group: 'BANK_TRANSFER_TRANSACTION_MANAGEMENT',
    isSystem: true,
  },
  {
    code: 'bank-transfer-transaction:get-by-id',
    name: 'Xem chi tiết giao dịch chuyển khoản',
    description: 'Xem chi tiết và dữ liệu gốc của giao dịch chuyển khoản ngân hàng',
    group: 'BANK_TRANSFER_TRANSACTION_MANAGEMENT',
    isSystem: true,
  },
  {
    code: 'bank-transfer-transaction:stats',
    name: 'Xem thống kê giao dịch chuyển khoản',
    description: 'Xem số lượng và tổng tiền giao dịch theo trạng thái đối soát',
    group: 'BANK_TRANSFER_TRANSACTION_MANAGEMENT',
    isSystem: true,
  },
  {
    code: 'bank-transfer-transaction:sync-sepay',
    name: 'Đồng bộ giao dịch SePay',
    description: 'Gọi SePay API v2 để bổ sung giao dịch ngân hàng và đối soát tự động',
    group: 'BANK_TRANSFER_TRANSACTION_MANAGEMENT',
    isSystem: true,
  },
  ...
  // ===================================
  {
    code: 'background-job:get-all',
    name: 'Xem danh sách job nền',
    description: 'Xem, lọc và phân trang cấu hình job nền của hệ thống',
    group: 'BACKGROUND_JOB_MANAGEMENT',
    isSystem: true,
  },
  {
    code: 'background-job:get-by-id',
    name: 'Xem chi tiết job nền',
    description: 'Xem cấu hình và trạng thái vận hành của một job nền',
    group: 'BACKGROUND_JOB_MANAGEMENT',
    isSystem: true,
  },
  {
    code: 'background-job:update',
    name: 'Cập nhật trạng thái job nền',
    description: 'Bật hoặc tắt job nền do hệ thống quản lý',
    group: 'BACKGROUND_JOB_MANAGEMENT',
    isSystem: true,
  },
  {
    code: 'background-job:get-locks',
    name: 'Xem lock job nền',
    description: 'Xem lock đa instance của các job nền',
    group: 'BACKGROUND_JOB_MANAGEMENT',
    isSystem: true,
  },
  {
    code: 'background-job:get-runs',
    name: 'Xem lần chạy job nền',
    description: 'Xem lịch sử chạy job nền',
    group: 'BACKGROUND_JOB_MANAGEMENT',
    isSystem: true,
  },
  {
    code: 'background-job:get-run-by-id',
    name: 'Xem chi tiết lần chạy job nền',
    description: 'Xem kết quả và lỗi đã lọc của một lần chạy job nền',
    group: 'BACKGROUND_JOB_MANAGEMENT',
    isSystem: true,
  },
  {
    code: 'background-job:get-sepay-sync-cursors',
    name: 'Xem cursor đồng bộ SePay',
    description: 'Xem checkpoint và lỗi vận hành của đồng bộ giao dịch SePay',
    group: 'BACKGROUND_JOB_MANAGEMENT',
    isSystem: true,
  },

  // ===================================
  // TUITION COLLECTION CONFIGURATION MANAGEMENT
  // ===================================
  {
    code: 'tuition-collection-configuration:manage',
    name: 'Cấu hình thu học phí',
    description: 'Xem và cập nhật mode thu học phí cùng tài khoản nhận tiền thủ công mặc định',
  ...
  },
  {
    ...
    description:
      'Cho phép truy cập vào trang xem chi tiết lớp học - thông tin, học viên, buổi học, điểm danh, thông báo',
    group: 'ADMIN_PAGE_ACCESS',
    isSystem: true,
  },
  {
  ...
  ...[
    ['assistant-shift:get-available-series', 'Xem chuỗi ca đang mở'],
    ['assistant-shift:get-all-series', 'Xem tất cả chuỗi ca'],
    ['assistant-shift:get-available-by-series', 'Xem ca đang mở theo chuỗi'],
    ['assistant-shift:get-all-by-series', 'Xem tất cả ca theo chuỗi'],
    ['assistant-shift:get-available-detail', 'Xem chi tiết ca đang mở'],
    ['assistant-shift:get-detail', 'Xem chi tiết ca'],
    ['assistant-shift:get-my-schedule', 'Xem lịch trợ giảng của tôi'],
    ['assistant-shift:get-my-monthly-statistics', 'Xem thống kê ca trợ giảng tháng này'],
    ['assistant-shift:get-assistants', 'Xem danh sách trợ giảng'],
    ['assistant-shift:create-series', 'Tạo chuỗi ca'],
    ['assistant-shift:update-series', 'Cập nhật chuỗi ca'],
    ['assistant-shift:delete-series', 'Xóa chuỗi ca'],
    ['assistant-shift:create', 'Tạo ca trợ giảng'],
    ['assistant-shift:update', 'Cập nhật ca trợ giảng'],
    ['assistant-shift:delete', 'Xóa ca trợ giảng'],
    ['assistant-shift:register', 'Tự đăng ký ca trợ giảng'],
    ['assistant-shift:cancel-registration', 'Hủy tự đăng ký ca trợ giảng'],
    ['assistant-shift:assign', 'Phân công trợ giảng'],
    ['assistant-shift:update-assignment', 'Cập nhật phân công trợ giảng'],
    ['assistant-shift:delete-assignment', 'Xóa phân công trợ giảng'],
    ['assistant-shift:check-in', 'Chấm công ca trợ giảng'],
    ['assistant-shift:copy', 'Sao chép ca trợ giảng theo chuỗi'],
    ['assistant-shift:lock-by-series', 'Khóa ca trợ giảng theo chuỗi'],
    ['assistant-shift:unlock-by-series', 'Mở khóa ca trợ giảng theo chuỗi'],
    ['assistant-shift:set-self-registration-window-by-series', 'Đặt thời gian tự đăng ký ca theo chuỗi'],
  ].map(([code, name]) => ({ code, name, description: name, group: 'ASSISTANT_SHIFT_MANAGEMENT', isSystem: true })),
  ...[
    ['assistant-task:get-all', 'Xem danh sách công việc trợ giảng'],
    ['assistant-task:get-by-id', 'Xem chi tiết công việc trợ giảng'],
    ['assistant-task:create', 'Tạo công việc trợ giảng'],
    ['assistant-task:update', 'Cập nhật công việc trợ giảng'],
    ['assistant-task:delete', 'Xóa công việc trợ giảng'],
  ].map(([code, name]) => ({
    code,
    name,
    description: name,
    group: 'ASSISTANT_TASK_MANAGEMENT',
    isSystem: true,
  })),
  ...[
    ['assistant-task-product:get-all', 'Xem tất cả sản phẩm trợ giảng'],
    ['assistant-task-product:get-by-id', 'Xem chi tiết sản phẩm trợ giảng'],
    ['assistant-task-product:get-my', 'Xem sản phẩm của tôi'],
    ['assistant-task-product:create-for-assistant', 'Tạo sản phẩm cho trợ giảng'],
    ['assistant-task-product:create-my', 'Tạo sản phẩm của tôi'],
    ['assistant-task-product:update', 'Cập nhật sản phẩm trợ giảng'],
    ['assistant-task-product:update-my', 'Cập nhật sản phẩm của tôi'],
    ['assistant-task-product:delete', 'Xóa sản phẩm trợ giảng'],
  ].map(([code, name]) => ({
    code,
    name,
    description: name,
    group: 'ASSISTANT_TASK_PRODUCT_MANAGEMENT',
    isSystem: true,
  })),
  ...[
    ['assistant-task-product-submission:get-all', 'Xem tất cả lần nộp sản phẩm'],
    ['assistant-task-product-submission:get-by-id', 'Xem chi tiết lần nộp sản phẩm'],
    ['assistant-task-product-submission:manage', 'Quản lý gắn và gỡ sản phẩm'],
    ['assistant-task-product-submission:self-manage', 'Tự gắn và gỡ sản phẩm của tôi'],
  ].map(([code, name]) => ({
    code,
    name,
    description: name,
