...
export const PERMISSIONS = [
  ...
  ...[
    ['assistant-shift:get-available-series', 'Xem chuỗi ca đang mở'], ['assistant-shift:get-all-series', 'Xem tất cả chuỗi ca'], ['assistant-shift:get-available-by-series', 'Xem ca đang mở theo chuỗi'], ['assistant-shift:get-all-by-series', 'Xem tất cả ca theo chuỗi'], ['assistant-shift:get-available-detail', 'Xem chi tiết ca đang mở'], ['assistant-shift:get-detail', 'Xem chi tiết ca'], ['assistant-shift:get-my-schedule', 'Xem lịch trợ giảng của tôi'], ['assistant-shift:get-my-monthly-statistics', 'Xem thống kê ca trợ giảng tháng này'], ['assistant-shift:create-series', 'Tạo chuỗi ca'], ['assistant-shift:update-series', 'Cập nhật chuỗi ca'], ['assistant-shift:delete-series', 'Xóa chuỗi ca'], ['assistant-shift:create', 'Tạo ca trợ giảng'], ['assistant-shift:update', 'Cập nhật ca trợ giảng'], ['assistant-shift:delete', 'Xóa ca trợ giảng'], ['assistant-shift:register', 'Tự đăng ký ca trợ giảng'], ['assistant-shift:cancel-registration', 'Hủy tự đăng ký ca trợ giảng'], ['assistant-shift:assign', 'Phân công trợ giảng'], ['assistant-shift:update-assignment', 'Cập nhật phân công trợ giảng'], ['assistant-shift:delete-assignment', 'Xóa phân công trợ giảng'], ['assistant-shift:check-in', 'Chấm công ca trợ giảng'], ['assistant-shift:copy', 'Sao chép ca trợ giảng theo chuỗi'], ['assistant-shift:lock-by-series', 'Khóa ca trợ giảng theo chuỗi'], ['assistant-shift:unlock-by-series', 'Mở khóa ca trợ giảng theo chuỗi'], ['assistant-shift:set-self-registration-window-by-series', 'Đặt thời gian tự đăng ký ca theo chuỗi'],
