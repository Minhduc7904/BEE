...
export const RESOURCE_TYPES = {
  ...
  TUITION_GRADE_BANK_ACCOUNT: 'TUITION_GRADE_BANK_ACCOUNT',
  TUITION_COLLECTION_CONFIGURATION: 'TUITION_COLLECTION_CONFIGURATION',
...
export const RESOURCE_TYPE_TABLE = {
  ...
  [RESOURCE_TYPES.RECEIVING_BANK_ACCOUNT]: {
    displayName: 'Receiving Bank Account',
    tableName: 'receiving_bank_accounts',
    primaryKey: 'receivingBankAccountId',
    repositoryName: 'receivingBankAccountRepository',
  },
  [RESOURCE_TYPES.TUITION_GRADE_BANK_ACCOUNT]: {
    displayName: 'Tuition Grade Bank Account',
    tableName: 'tuition_grade_receiving_bank_accounts',
    primaryKey: 'tuitionGradeReceivingBankAccountId',
    repositoryName: 'tuitionGradeReceivingBankAccountRepository',
  },
  [RESOURCE_TYPES.TUITION_COLLECTION_CONFIGURATION]: {
    displayName: 'Tuition Collection Configuration',
    tableName: 'tuition_collection_configurations',
    primaryKey: 'tuitionCollectionConfigurationId',
    repositoryName: 'tuitionCollectionConfigurationRepository',
  },
  [RESOURCE_TYPES.PAYMENT_INTENT]: {
    displayName: 'Payment Intent',
    tableName: 'payment_intents',
    primaryKey: 'paymentIntentId',
    repositoryName: 'paymentIntentRepository',
  },
  [RESOURCE_TYPES.BANK_TRANSFER_TRANSACTION]: {
    displayName: 'Bank Transfer Transaction',
    tableName: 'bank_transfer_transactions',
    primaryKey: 'bankTransferTransactionId',
    repositoryName: 'bankTransferTransactionRepository',
  },
  [RESOURCE_TYPES.BACKGROUND_JOB]: {
    displayName: 'Background Job',
    tableName: 'background_jobs',
    primaryKey: 'backgroundJobId',
    repositoryName: 'backgroundJobRepository',
  },
